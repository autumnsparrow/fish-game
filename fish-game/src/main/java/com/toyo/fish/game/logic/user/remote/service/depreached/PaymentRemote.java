 ...
 *
 */
//public class PaymentRemote extends RemoteObjectCache {
	
//	private static final Log logger = LogFactory.getLog(PaymentRemote.class);
//	
//
//	public PaymentRemote(Long id) {
//		super(id);
...
//		
//		UserAccountRemote userAccount=RemoteObjectCache.getObject(id, UserAccountRemote.class);
//		Integer channelId=userAccount.userAccountInfo.getAccount().getChannelId();
//		
...
//		IPaymentService service=GlobalUserManager.remotePaymentService();
//		Login login=getLogin();
//		List<PaymentOrder> data=service.getPaymentOrder(id, login.getDeviceId());
//		
...
//		Integer channelId=userAccount.userAccountInfo.getAccount().getChannelId();
//		
//		VivoOrder order=service.getVivoOrder(req.getProductId(), req.getProductTitle(), req.getProductDescription(), req.getPrice(), channelId, id, login.getDeviceId());
//		
//		//String orderId=service.getOrderId(req.getProductId(), req.getPrice(),channelId, id, login.getDeviceId());
//		
...
//		//boolean ret=service.validFlymeSession(req.getUid(), req.getSessionId());
//		//boolean ret=service.validWdjToken(req.getUid(), req.getToken());
//		LenovoOrder order=service.getLenovoOrderId(req.getProductId(), req.getProductTitle(), req.getPrice(), channelId, getId(), evt.header.getDeviceId());
