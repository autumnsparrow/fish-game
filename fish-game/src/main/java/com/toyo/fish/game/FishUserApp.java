...
public class FishUserApp 
{
	...
	public static void main( String[] args )
    {
    	...
    	SpringContext.init("classpath:/META-INF/spring/debug/applicationContext-*.xml");
    	}else{
    		System.out.println("##########RELEASE MODE##############");
    		SpringContext.init(new String[]{
        			"classpath:/META-INF/spring/release/applicationContext-fish-protocol-service-user.xml",
        			"classpath:/META-INF/spring/release/applicationContext-fish-user.xml"
