...
import com.toyo.fish.protocol.beans.PP0000Beans;
import com.toyo.fish.protocol.beans.PP0000Beans.Extra;
...
@HandlerAsyncType(enable=true,enableFilter=true,namespace="ProtocolFriendsSystem",transcode="PFS[0-9][0-9][0-9][0-9]")
@Component("PFS0000Handler")
public class PFS0000Handler  extends BasicHandler {
