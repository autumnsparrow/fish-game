...
@HandlerAsyncType(enable=true,enableFilter=true,namespace="ProtocolMailSystem",transcode="PMS[0-9][0-9][0-9][0-9]")
@Component("PMS0000Handler")
public class PMS0000Handler  extends BasicHandler {
