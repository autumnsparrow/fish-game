	...
	public static void main( String[] args )
    {
    	...
    	if(flag){
    		...
    		SpringContext.init(new String[]{
    			"classpath:/META-INF/spring/debug/applicationContext-fish-protocol-service-system.xml",
    			"classpath:/META-INF/spring/debug/applicationContext-fish-system.xml"
    			
    		});
    	}else{
    		System.out.println("##########RELEASE MODE##############");
    		SpringContext.init(new String[]{
        			"classpath:/META-INF/spring/release/applicationContext-fish-protocol-service-system.xml",
        			"classpath:/META-INF/spring/release/applicationContext-fish-system.xml"
