...
@HandlerAsyncType(enable=true,enableFilter=true,namespace="ProtocolFishUser",transcode="PFU[0-9][0-9][0-9][0-9]")
@Component("PFU0000Handler")
public class PFU0000Handler   extends BasicHandler{
