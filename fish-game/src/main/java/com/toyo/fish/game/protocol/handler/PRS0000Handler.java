...
@HandlerAsyncType(enable=true,enableFilter=true,namespace="ProtocolRankSystem",transcode="PRS[0-9][0-9][0-9][0-9]")
@Component("PRS0000Handler")
public class PRS0000Handler   extends BasicHandler{
