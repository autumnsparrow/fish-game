...
@HandlerAsyncType(enable=true,enableFilter=true,namespace="ProtocolPayment",transcode="PP[0-9][0-9][0-9][0-9]")
@Component("PP0000Handler")
public class PP0000Handler  extends BasicHandler {
