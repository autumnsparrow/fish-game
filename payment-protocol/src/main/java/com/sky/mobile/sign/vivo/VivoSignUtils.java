package com.sky.mobile.sign.vivo;
...
public class VivoSignUtils {
    ...
    public static void main(String[] args) {  
    	...
    	para.put("storeId", "20140702025804544919");
    	para.put("appId", "f728ddbb5ffb50137f79c63c19e4459f");
    	...
    	String key = "3ddf395038e95fe6ddb4d40baaf973f5";
		...
		para.put("signMethod", "MD5");
		para.put("signature", sign);
    	String content=HttpUtil.httpPost("https://pay.vivo.com.cn//vivoPay/getVivoOrderNum", para);
