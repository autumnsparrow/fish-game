...
public class MeizuController {
	...
	private static final Log logger=LogFactory.getLog(MeizuController.class);
	...
	public ResponseEntity<String> notify(
		...
		try {
			...
			String localSign=SignUtil.getSignCode(params, errorMessage.meizuKeys.getAppSecret());
			//TODO: valid the sign 
