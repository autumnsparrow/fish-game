...
//        	src = Base64.decodeBase64(src);
    ...
    public static  String encrypt(Object obj,String desKey) throws UnsupportedEncodingException{
    	...
    	String req=encrypt(json, desKey);
    	return req;
    ...
    public static <T> T decrypt(String req,String desKey,Class<?> clz) throws UnsupportedEncodingException{
    	String ming=decrypt(req, desKey);
    	T t=GameContextGlobals.getJsonConvertor().convert(ming, clz);
    	return t;
    }
    
    public static String decrypt(String json,String key) throws UnsupportedEncodingException{
    	byte[] reqBase64=org.apache.commons.codec.binary.Base64.decodeBase64(json);
    	byte[] decrypt = DES.des().decrypt(key,reqBase64);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
    	String desKey="414120551070436265677233";
    	...
    	String req=request(10000, request, desKey);
