...
import com.ipay.res.SubAuthRes;
import com.ipay.util.ConstValue;

public class SubAuthReq extends IpayRequestBase {

	
	public SubAuthRes send(){
		...
		return new SubAuthRes( responseStr );
	}
	
	
	@Override
	protected String getRequestUrl() {
		return "/payapi/subsauth";
	}
